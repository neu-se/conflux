package edu.gmu.swe.test.phosphor.binding;
...
import static edu.gmu.swe.test.phosphor.binding.GeneralBindingControlITCase.createDigitArray;
import static edu.gmu.swe.test.phosphor.binding.GeneralBindingControlITCase.taintWithIndices;
