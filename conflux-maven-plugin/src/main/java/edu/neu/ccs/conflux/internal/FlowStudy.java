 ...
 * It must have only one parameter of type {@link StudyTaintTagChecker}.
 * This <code>BenchTaintTagChecker</code> is used by the study to check whether the set of taint tags
